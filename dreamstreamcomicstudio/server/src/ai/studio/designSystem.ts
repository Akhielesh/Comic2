...
export const DESIGN_PRESETS: DesignPreset[] = [
  ...
  // --- Named brand systems (onboarded from open-design's design-systems/) -----------------------
  { id: 'stripe', name: 'Stripe', category: 'brand', tagline: 'developer-fintech premium, calm + precise', keywords: ['stripe', 'fintech', 'payments', 'developer', 'api', 'billing'], directive: 'Stripe: developer-fintech premium — clean humanist sans, a calm indigo/violet accent, soft layered shadows, immaculate spacing, crisp data tables, tasteful animated gradient accents, confident but understated. Trust + polish above flash.' },
  { id: 'linear', name: 'Linear', category: 'brand', tagline: 'hyper-crisp product, keyboard-first', keywords: ['linear', 'issues', 'tracker', 'sprint', 'roadmap'], directive: 'Linear: hyper-crisp product UI — near-monochrome with a single electric accent, dense yet airy, fast 100–150ms interactions, keyboard-first, subtle glow/gradients on a dark base, pixel-perfect alignment. Nothing wasted.' },
  { id: 'vercel-geist', name: 'Vercel / Geist', category: 'brand', tagline: 'stark black & white, technical', keywords: ['vercel', 'geist', 'nextjs', 'deploy', 'black and white'], directive: 'Vercel/Geist: stark black-and-white, Geist-style sans + mono, hairline borders, high contrast, generous whitespace, minimal color, sharp focus rings; dark-first, technical elegance.' },
  { id: 'notion', name: 'Notion', category: 'brand', tagline: 'calm, content-first, block-based', keywords: ['notion', 'wiki', 'notes', 'blocks'], directive: 'Notion: calm content-first workspace — warm off-white surfaces, restrained grays, comfortable type, hover-revealed controls, block-based layout, minimal chrome, gentle dividers. The content is the hero.' },
  { id: 'github', name: 'GitHub', category: 'brand', tagline: 'dependable developer UI', keywords: ['github', 'repo', 'open source', 'pull request', 'commits'], directive: 'GitHub: dependable developer UI — neutral grays with blue/green semantic accents, system font, dense lists + tables, clear primary buttons, full light/dark parity, strong accessibility.' },
  { id: 'airbnb', name: 'Airbnb', category: 'brand', tagline: 'warm, friendly marketplace', keywords: ['airbnb', 'marketplace', 'travel', 'booking', 'listings', 'rental'], directive: 'Airbnb: warm friendly marketplace — rounded humanist sans, a coral/rausch accent, large rounded imagery cards, soft shadows, generous spacing, welcoming and trustworthy.' },
  { id: 'spotify', name: 'Spotify', category: 'brand', tagline: 'bold dark media, vivid green', keywords: ['spotify', 'music', 'audio', 'player', 'podcast'], directive: 'Spotify: bold dark media UI — near-black surfaces, a vivid green accent, large album/cover art, rounded controls, smooth scrolling + playful motion, high energy but legible.' },
  { id: 'apple-hig', name: 'Apple (HIG)', category: 'brand', tagline: 'refined system UI, deference to content', keywords: ['apple', 'hig', 'macos', 'visionos', 'refined'], directive: 'Apple HIG: refined system UI — SF-style type, large titles, translucency/vibrancy, system grays, restrained color, precise spacing, fluid spring motion, deference to content. (For mobile use the ios-native preset.)' },
  { id: 'tesla', name: 'Tesla', category: 'brand', tagline: 'minimal premium hardware, cinematic', keywords: ['tesla', 'automotive', 'hardware', 'cinematic'], directive: 'Tesla: minimal premium hardware — vast black/white space, thin elegant sans, full-bleed product imagery, sparse UI, dramatic photography, restrained controls. Cinematic and confident.' },
  { id: 'coinbase', name: 'Coinbase', category: 'brand', tagline: 'trustworthy crypto-fintech', keywords: ['coinbase', 'crypto', 'exchange', 'wallet', 'trading'], directive: 'Coinbase: trustworthy crypto-fintech — a clean blue palette, clear data + charts, rounded cards, confident type, calm motion, security-forward, accessible.' },
  { id: 'openai', name: 'OpenAI', category: 'brand', tagline: 'clean modern AI product, calm', keywords: ['openai', 'chatbot', 'assistant', 'llm', 'gpt'], directive: 'OpenAI: clean modern AI product — near-monochrome with soft neutral surfaces, generous whitespace, simple geometric sans, a subtle teal/green accent, restrained and approachable, research-grade calm.' },
  { id: 'perplexity', name: 'Perplexity', category: 'brand', tagline: 'answer-engine, cited, calm teal', keywords: ['perplexity', 'answer engine', 'citations', 'ai search'], directive: 'Perplexity: answer-engine UI — a calm teal/peacock accent, content-first reading layout, cited source cards, dark-first, crisp typography, minimal but warm.' },
  { id: 'figma', name: 'Figma', category: 'brand', tagline: 'creative-tool vibrancy + precision', keywords: ['figma', 'design tool', 'canvas editor', 'creative tool'], directive: 'Figma: creative-tool vibrancy — playful multi-color accents on clean canvas grays, rounded panels, crisp icons, smooth tool interactions, friendly + precise.' },
  { id: 'framer', name: 'Framer', category: 'brand', tagline: 'motion-forward marketing, sleek', keywords: ['framer', 'marketing site', 'agency site', 'animated landing'], directive: 'Framer: motion-forward marketing — bold modern sans, high-contrast sections, gradient accents, abundant scroll-driven animation and micro-motion (honor reduced-motion). Sleek and contemporary.' }
];
...
export const DESIGN_SKILLS: DesignSkill[] = [
  ...
  { id: 'ambient-bg', name: 'Ambient animated background', keywords: ['background', 'ambient', 'gradient', 'aurora', 'hero', 'motion', 'animated'], directive: 'Ambient animated background: a slowly shifting CSS/canvas gradient or aurora looping behind content (GPU transform/filter, ~15–30s loop); keep it low-contrast behind text and pause on prefers-reduced-motion.' },
  { id: 'kinetic-type', name: 'Kinetic typography', keywords: ['kinetic', 'typography', 'headline', 'hero', 'text animation', 'motion'], directive: 'Kinetic typography: reveal a hero headline word- or letter-by-letter (stagger 30–60ms, mask/blur-up) with Framer Motion; reduced-motion → render static immediately.' },
  { id: 'scroll-scene', name: 'Scroll-driven scene', keywords: ['scroll', 'scene', 'scrollytelling', 'pin', 'progress', 'story', 'motion'], directive: 'Scroll-driven scene: pin a section and drive its animation by scroll progress (Framer Motion useScroll/scrollYProgress or CSS scroll-timeline) — layered transforms + opacity; degrade to static on reduced-motion.' },
  { id: 'parallax', name: 'Parallax depth', keywords: ['parallax', 'depth', 'layers', 'scroll', 'motion'], directive: 'Parallax depth: move background/foreground layers at different scroll speeds for depth — subtle (≤20% offset), transform-only; disable on prefers-reduced-motion and where it janks on touch.' },
  { id: 'vector-motion', name: 'Vector motion (Lottie/Rive)', keywords: ['lottie', 'rive', 'animation', 'illustration', 'motion graphics', 'animated icon'], directive: 'Vector motion: embed a Lottie (lottie-react) or Rive animation for rich looping illustrations/icons; lazy-load, pause when offscreen, and provide a static poster + reduced-motion fallback.' },
  { id: 'canvas-fx', name: 'Generative canvas FX', keywords: ['canvas', 'particles', 'generative', 'webgl', 'constellation', 'waves', 'effect', 'motion graphics'], directive: 'Generative canvas FX: a lightweight requestAnimationFrame canvas effect (particles/waves/constellation) behind the hero; cap devicePixelRatio + particle count for perf, pause offscreen, and honor reduced-motion.' },
  { id: 'celebration', name: 'Celebration moment', keywords: ['confetti', 'celebration', 'success', 'reward', 'win', 'complete', 'congrats'], directive: 'Celebration moment: a tasteful confetti/particle burst on a key success (purchase, completion, win) via canvas-confetti or a one-shot particle burst (~1.5s); never on every action; reduced-motion safe.' },
  // --- Games (the most-requested studio build, and historically the weakest output) ------------
  { id: 'game-core', name: 'Game core (loop + states)', keywords: ['game', 'arcade', 'snake', 'tetris', 'pong', 'breakout', 'platformer', 'shooter', 'flappy', 'pacman', 'pac-man', '2048', 'minesweeper', 'racing', 'jumper', 'runner', 'invaders', 'asteroids'], directive: 'Game core: a REAL fixed-timestep loop (requestAnimationFrame + delta/accumulator — never rely on render cadence for physics), a state machine (start screen → playing → paused → game over → restart), keyboard (arrows/WASD + space) AND touch/click controls (on-screen buttons or swipe on mobile), genuine collision detection, scoring, lives/health, a difficulty ramp, and a localStorage high score. Canvas for fast-moving scenes, DOM/CSS for board games. The game must be fully PLAYABLE end-to-end — a static board or a loop comment is a failure.' },
  { id: 'game-feel', name: 'Game feel (juice)', keywords: ['game', 'arcade', 'juice', 'shake', 'combo', 'powerup', 'power-up', 'level'], directive: 'Game feel: immediate feedback for every event — hit flash, small particle burst, subtle screen shake on impact, eased score pop-ups, spawn/despawn tweens, a clean HUD (score/lives/level in tabular-nums), distinct win/lose screens with a one-key restart, and a brief "ready?" countdown into play. Respect prefers-reduced-motion (reduce shake/particles, never gameplay).' },
  // --- Branding / systems / data / 3D / product patterns (from open-design skill themes) -------
  { id: 'brand-system', name: 'Brand system', keywords: ['brand', 'branding', 'logo', 'identity', 'guidelines'], directive: 'Brand system: commit to a cohesive identity — a logotype/mark, one primary + one accent color with tints, a display+body type pairing, an icon style, and a consistent voice. Apply it across every screen; document it in a small style note.' },
  { id: 'color-system', name: 'Color system', keywords: ['color', 'palette', 'theme', 'tokens', 'contrast'], directive: 'Color system: define semantic CSS-variable tokens (bg/surface/fg/muted/primary/accent/success/warn/error) for light AND dark, all meeting ≥4.5:1 contrast; build shades from a base via consistent steps. Use tokens everywhere, never raw one-off hexes.' },
  { id: 'type-system', name: 'Type system', keywords: ['typography', 'type scale', 'fonts', 'headings'], directive: 'Type system: a modular type scale (e.g. 1.2–1.25 ratio), a display+body pairing, consistent line-heights (1.1–1.3 headings, 1.5–1.7 body), measure ≤75ch, and weights used purposefully. Map to tokens.' },
  { id: 'd3-charts', name: 'Data viz (charts)', keywords: ['chart', 'graph', 'data viz', 'd3', 'analytics', 'plot', 'dashboard'], directive: 'Data viz: use a real chart lib (recharts/visx/d3) with accessible labels, legends, tooltips, responsive sizing, empty/loading states, and tabular-nums. Pick the right chart for the data; never fake values.' },
  { id: 'three-d', name: '3D / WebGL', keywords: ['3d', 'three', 'webgl', 'r3f', 'model', 'scene'], directive: '3D: react-three-fiber / three.js for tasteful 3D — lazy-loaded, capped DPR + draw calls, suspense fallback, pause when offscreen, OrbitControls where useful, and a 2D fallback. Performance + reduced-motion aware.' },
  { id: 'social-cards', name: 'Social / OG cards', keywords: ['og image', 'open graph', 'social card', 'share', 'twitter card', 'meta image'], directive: 'Social cards: generate Open Graph + Twitter card meta and a branded share image (1200×630) per page; consistent template (title, subtitle, logo, accent).' },
  { id: 'auth-flow', name: 'Auth flow', keywords: ['auth', 'login', 'signup', 'sign in', 'session', 'account'], directive: 'Auth flow: sign-in/up with validation, password show/hide, OAuth buttons where relevant, session persistence, protected routes with redirects, and clear error/empty/loading states. Never store secrets client-side.' },
  { id: 'forms-validation', name: 'Forms + validation', keywords: ['form', 'validation', 'input', 'fields', 'submit'], directive: 'Forms: react-hook-form + zod (or equivalent) with inline, accessible errors (aria-describedby), disabled-while-submitting, optimistic success, and keyboard-friendly fields. Validate on blur + submit.' },
  { id: 'search-filter', name: 'Search + filter', keywords: ['search', 'filter', 'facets', 'sort', 'query'], directive: 'Search + filter: debounced search, faceted/sortable filters reflected in the URL, clear-all, result counts, and distinct empty vs no-results states.' },
  { id: 'onboarding-tour', name: 'Onboarding tour', keywords: ['onboarding', 'tour', 'walkthrough', 'coachmarks', 'first run', 'getting started'], directive: 'Onboarding: a short first-run flow or coachmark tour highlighting key actions, skippable + resumable, progress indicated, persisted as completed. Welcoming, not nagging.' },
  { id: 'pricing-table', name: 'Pricing table', keywords: ['pricing', 'plans', 'tiers', 'subscription', 'billing'], directive: 'Pricing table: clear tiers with a highlighted recommended plan, monthly/annual toggle, feature comparison, prominent CTAs, and trust/FAQ below. Honest, scannable.' },
  { id: 'seo-meta', name: 'SEO + metadata', keywords: ['seo', 'meta', 'sitemap', 'structured data', 'schema.org'], directive: 'SEO: per-page title/description, canonical, Open Graph + Twitter tags, JSON-LD structured data where relevant, a sitemap + robots, semantic headings, and fast accessible markup.' },
  { id: 'i18n', name: 'Internationalization', keywords: ['i18n', 'translation', 'locale', 'rtl', 'language'], directive: 'i18n: externalize copy into a locale catalog, a language switcher, locale-aware dates/numbers, and RTL-ready layouts (logical CSS properties). No hard-coded user-facing strings.' },
  { id: 'realtime', name: 'Realtime / live updates', keywords: ['realtime', 'live', 'websocket', 'presence', 'collaboration', 'sync'], directive: 'Realtime: WebSocket/SSE live updates with optimistic UI, reconnect/backoff, presence indicators, and clear connected/disconnected states; degrade gracefully to polling.' },
  { id: 'print-styles', name: 'Print styles', keywords: ['print', 'pdf', 'invoice', 'report', 'printable'], directive: 'Print styles: a dedicated @media print stylesheet — hide nav/controls, black-on-white, page-break control, and a print/“save as PDF” action. Great for invoices/reports/resumes.' },
  { id: 'error-boundaries', name: 'Resilient errors', keywords: ['error', 'boundary', 'fallback', 'crash', 'retry'], directive: 'Resilient errors: React error boundaries with friendly fallback + retry, guarded async (try/catch + typed errors), and never a blank white screen. Log to the console, recover gracefully.' }
];
