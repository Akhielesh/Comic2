...
export const TOOL_CATALOG: ToolMeta[] = [
  ...
  },
  {
    ...
    description: 'Drop a fully playable mini-game into the chat — Snake, Brick breaker (paddle) or 2048 — with keyboard + touch controls, Compact/Medium/Large sizes and a fullscreen toggle.',
    auth: 'none', rateLimit: 'Unlimited (renders locally, no API)',
    dataShape: 'Interactive game card: canvas/DOM game, score + best, resizable, fullscreen.', docsUrl: 'https://dreamstream.app',
    keywords: ['game', 'games', 'play', 'play a game', 'snake', 'breakout', 'brick breaker', '2048', 'arcade', 'mini game', 'bored', 'take a break']
  },
  {
