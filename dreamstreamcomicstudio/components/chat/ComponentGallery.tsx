...
const emailDemoMessages: EmailInboxArtifact['emails'] = [
  {
    id: 'm1', threadId: 't1', subject: 'Q3 board deck — final v4 (with appendix)', from: { name: 'Dana Whitfield', email: 'dana@northwind.co' }, to: 'you@gmail.com',
    snippet: 'Hi — attaching the final board deck. The appendix now has the cohort retention curves you asked for…', date: new Date(Date.now() - 36 * 60_000).toISOString(),
    unread: true, starred: true, category: 'primary', hasAttachments: true, labels: ['INBOX', 'UNREAD', 'STARRED', 'CATEGORY_PERSONAL'], url: 'https://mail.google.com/mail/u/0/#all/m1',
    ...
    html: '<div style="font-family:system-ui"><p>Hi —</p><p>Attaching the <strong>final board deck</strong>. The appendix now has the cohort retention curves you asked for, plus the updated ARR bridge.</p><p>Live preview: <a href="https://example.com/deck">open the deck</a>.</p><p>Thanks,<br>Dana</p></div>',
    attachments: [{ attachmentId: 'a1', filename: 'Q3-board-deck-v4.pdf', mimeType: 'application/pdf', size: 2_400_000 }]
  },
  { id: 'm2', threadId: 't2', subject: 'Re: invoice #4471', from: { name: 'Billing · Vercel', email: 'billing@vercel.com' }, to: 'you@gmail.com', snippet: 'Your receipt for the Pro plan is attached. Next charge: Jul 1.', date: new Date(Date.now() - 3 * 3600_000).toISOString(), unread: true, category: 'updates', labels: ['INBOX', 'UNREAD', 'CATEGORY_UPDATES'], url: 'https://mail.google.com/mail/u/0/#all/m2' },
  { id: 'm3', threadId: 't3', subject: 'Lunch Thursday?', from: { name: 'Marcus Lee', email: 'marcus@gmail.com' }, to: 'you@gmail.com', snippet: 'Free around 12:30 near the office? That new ramen place finally opened.', date: new Date(Date.now() - 26 * 3600_000).toISOString(), unread: false, category: 'primary', labels: ['INBOX', 'CATEGORY_PERSONAL'], url: 'https://mail.google.com/mail/u/0/#all/m3' },
  { id: 'm4', threadId: 't4', subject: '🔥 48h only: 40% off everything', from: { name: 'Acme Store', email: 'deals@acme.com' }, to: 'you@gmail.com', snippet: 'Our biggest sale of the season ends Sunday — shop now.', date: new Date(Date.now() - 2 * 24 * 3600_000).toISOString(), unread: false, category: 'promotions', labels: ['INBOX', 'CATEGORY_PROMOTIONS'], url: 'https://mail.google.com/mail/u/0/#all/m4' }
];
const emailInboxDemo: EmailInboxArtifact = { box: 'inbox', category: 'primary', account: 'you@gmail.com', accountLabel: 'you@gmail.com', connectionId: 'demo-connection', emails: emailDemoMessages, nextCursor: null };
const emailUnreadDemo: EmailInboxArtifact = { box: 'unread', category: 'primary', account: 'you@gmail.com', accountLabel: 'you@gmail.com', connectionId: 'demo-connection', emails: emailDemoMessages.filter((m) => m.unread), nextCursor: null };
