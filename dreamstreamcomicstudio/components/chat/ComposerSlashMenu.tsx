...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { id: 'calendar-free', label: 'Calendar · Free time', hint: 'Find open slots in your week', Icon: CalendarClock, prompt: 'When am I free this week?', send: true, toolCategory: 'productivity', keywords: ['calendar', 'free', 'busy', 'availability', 'open slots'] },
  { id: 'calendar-create', label: 'Calendar · New event', hint: 'Schedule something (you confirm before it saves)', Icon: CalendarPlus, prompt: 'Add to my calendar: ', toolCategory: 'productivity', keywords: ['calendar', 'schedule', 'create', 'event', 'meeting', 'book', 'add'] },
