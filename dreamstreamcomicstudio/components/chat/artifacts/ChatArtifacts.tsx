...
import type { ClarifyArtifact, GameArtifact, EmailInboxArtifact, EmailComposeArtifact, AgentActivityArtifact } from '../../../apiTypes';
...
const ARTIFACT_RENDERERS: Record<string, (data: unknown, key: number) => React.ReactNode> = {
  ...
  agent_activity: (d, k) => <AgentActivityCard key={k} data={d as AgentActivityArtifact} />,
