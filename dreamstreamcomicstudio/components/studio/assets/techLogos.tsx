// Tech-stack logos for Code Studio template chips. The TypeScript / JavaScript / HTML5 marks
// were sourced via the 21st.dev Magic MCP (logo_search); the React mark is the standard atom.
// Each is a self-contained SVG sized by className (default 1em).
...
export const ReactLogo: React.FC<LogoProps> = ({ className }) => (
  <svg className={className} viewBox="-11.5 -10.23 23 20.46" width="1em" height="1em" aria-hidden>
...
export const TypeScriptLogo: React.FC<LogoProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 256 256" width="1em" height="1em" aria-hidden preserveAspectRatio="xMidYMid">
...
export const JavaScriptLogo: React.FC<LogoProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 1052 1052" width="1em" height="1em" aria-hidden>
...
export const Html5Logo: React.FC<LogoProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 452 520" width="1em" height="1em" aria-hidden>
...
const TEMPLATE_LOGO: Record<string, React.FC<LogoProps>> = {
  'react-ts': ReactLogo,
  react: ReactLogo,
  'vanilla-ts': TypeScriptLogo,
  vanilla: JavaScriptLogo,
  static: Html5Logo,
};

/** Render the logo for a Code Studio template id (falls back to the React mark). */
export const TemplateLogo: React.FC<{ template: string; className?: string }> = ({ template, className }) => {
  const Logo = TEMPLATE_LOGO[template] ?? ReactLogo;
