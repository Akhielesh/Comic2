...
export const CHAT_CONNECTORS: ChatConnector[] = [
  {
    id: 'web',
    label: 'Web & tools',
    description: 'Free, keyless live tools: web/image/video search (DuckDuckGo), live news (Google News), weather (Open-Meteo), stock quotes (Stooq), nearby places (OpenStreetMap) and interactive maps — plus chart and KPI-board rendering. The model searches, shows media, renders news/weather/stock/local cards, draws charts and metric boards, and opens maps.',
    toolNames: ['web_search', 'image_search', 'video_search', 'get_news', 'get_weather', 'get_stock', 'find_places', 'show_map', 'render_chart', 'show_metrics']
  },
  {
    id: 'agents',
    label: 'Agent swarm',
